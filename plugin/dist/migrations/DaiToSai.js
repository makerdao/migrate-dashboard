...
/*#__PURE__*/
function () {
  function DaiToSai(manager) {
    (0, _classCallCheck2["default"])(this, DaiToSai);
    this._manager = manager;
    this._dai = manager.get('token').getToken(_.DAI);
    return this;
  }

  (0, _createClass2["default"])(DaiToSai, [{
    key: "check",
    value: function () {
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", this._dai.balance());
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 6:
                ...
                _context2.next = 10;
                return this._dai.approve(migrationContract.address, formattedAmount, {
                  promise: promise
                });

              case 10:
                return _context2.abrupt("return", migrationContract.swapDaiToSai(formattedAmount, {
                  promise: promise
                }));
