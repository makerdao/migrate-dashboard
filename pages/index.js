    ...
    <Flex flexDirection="column" minHeight="100vh">
      ...
      >
        ...
        >
          ...
          <Breakout>
            ...
            versions, and claims funds after emergency shutdown and other system
            updates.
          </Breakout>
        </Box>
        <WalletManager />
      ...
      <Box bg="white" flexGrow="1">
        <Box maxWidth="113.4rem" width="100%" m="0 auto" px="m" mt="xl">
          <Grid
            gridTemplateColumns={{ s: '1fr', l: 'repeat(3, 1fr)' }}
            gridColumnGap="2xl"
            gridRowGap="xl"
          >
            <Feature
              title="Migrate CDPs"
              body="During a system upgrade, migrate CDPs to move them into the new system. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor."
            />
            <Feature
              title="Redeem DAI & MKR"
              body="During a system upgrade, migrate CDPs to move them into the new system. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor."
            />
            <Feature
