    ...
    <FlowBackground open={open}>
      <Grid gridRowGap="xl">
        ...
        <Flex flexDirection="column" alignItems="center">
          <Text.h2 textAlign="center" mb="s">
            Approve exchange of tokens
          </Text.h2>
          <Text.p fontSize="xl" color="darkLavender" textAlign="center">
            This transaction allows the redeemer contract to operate on your Dai
            tokens.
          </Text.p>
          <Button variant="secondary" mt="l">
