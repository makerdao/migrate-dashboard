...
const TxLoader = ({hash}) => {
  return (<Flex alignItems="center" p="0px">
    <img src={threeDots} />
    <Text mx="m" fontSize="16px">TX in progress</Text>
    {typeof hash !== 'undefined' ? <Box
    ...
    >
      ...
      <Link target="_blank" href={`https://etherscan.io/tx/${hash}`}><img src={arrowTopRight} /></Link>
    </Box> : null}
  </Flex>)
}

export default function FlowHeader({ account, loading, hash }) {
  return (
    <Grid
